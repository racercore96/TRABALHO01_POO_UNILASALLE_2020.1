...
public class PartidaTester {
	public static void main(String[] args) {
		...
		System.out.println("***********************************");
		System.out.println("Integrante do Grupo: Pedro Henrique.");
		System.out.println("Integrante do Grupo: Jader Assis.");
		System.out.println("Integrantes do Grupo: Renato Machado.");
		System.out.println("***********************************");
		System.out.println("GitHub>>>https://github.com/racercore96/TRABALHO01_POO_UNILASALLE_2020.1.git");
		System.out.println("***********************************");
